...
import Preview1 from "../../assets/portfolio/project01/preview-01.png";
import Preview2 from "../../assets/portfolio/project02/preview-02.png";
import Preview3 from "../../assets/portfolio/project03/preview-03.png";
import Preview4 from "../../assets/portfolio/project04/preview-04.png";
      ...
      projects: [
        {
          ...
          preview: Preview1,
          title: "Videos",
          tag: "Conecta con turistas y locales en cada trayecto.",
        },
        {
          id: "2",
          preview: Preview2,
          title: "Anuncios con QR para escanear.",
          tag: "Permite a pasajeros acceder a promos, menús, cupones o páginas web al instante.",
        },
        {
          id: "3",
          preview: Preview3,
          title: "Diseños vibrantes",
          tag: "Colores vivos que captan la atención y generan recordación de marca.",
        },
        {
          id: "4",
          preview: Preview4,
          title: "Publicidad en movimiento.",
          tag: "Conecta con turistas y locales en cada trayecto.",
        },
        // {
        //   id: "5",
    ...
    return (
      <div id="portfolio">
        <div className="wrapper">
          <Title title="Llega a todas partes." />
          <Row>
              ...
              <div className="portfolio__nav">
                <ul>
                  ...
                  <li
                    ...
                    onClick={() => this.filterGallery("Conecta con turistas y locales en cada trayecto.")}
                  >
                    Video Anuncios
                  </li>
                  <li
                    className={this.state.pickedFilter === "illustrations" ? "portfolio__nav-active font12" : "font12"}
                    onClick={() => this.filterGallery("Colores vivos que captan la atención y generan recordación de marca.")}
                  >
                    Diseños Impactantes
                  </li>
                  <li className={this.state.pickedFilter === "web" ? "portfolio__nav-active font12" : "font12"} onClick={() => this.filterGallery("Permite a pasajeros acceder a promos, menús, cupones o páginas web al instante.")}>
                    Escanea y Conecta
                  </li>
                </ul>
              </div>
          ...
          <Row className="flex-center padding40">
            <Button label="Promociona Mi Negocio" target={"contact"} />
          </Row>
        </div>
      </div>
    );
