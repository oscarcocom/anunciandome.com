    ...
    return (
      <div className="blog" id="blog">
        <div className="wrapper">
          ...
          <p className="font12">
          En Anunciandome.com somos una empresa de tecnología en crecimiento con una misión clara: crear publicidad más efectiva y generar ingresos extra para conductores.
Creemos en conectar marcas con personas reales en el momento y lugar adecuados, transformando cada viaje en una oportunidad de impacto.

Nuestro compromiso es ayudarte a mejorar tu negocio con anuncios medibles y a nuestros socios conductores a incrementar sus ingresos de manera sencilla y transparente.
          </p>
